...
namespace Tonal.WebService.Members.Controllers
{
    ...
    public class BirthDateEmotionController : ApiController
    {
        [Route("api/birthdate/emotion")]
        public IHttpActionResult Get()
        {
            IHttpActionResult actionResult;

            Tonal.Data.AnalysisDataService ds = new Tonal.Data.AnalysisDataService();
            var dt = ds.GetAnalysis(Model.Category.emotion_tone.ToString(), (int)Model.Demographic.birthDate);
